...
function GamePage() {
  ...
  const questions = [
    {
      hints: [
        "تلميح أول:  أول مخرجة سعودية تقدم عملاً من تأليفها أول مخرجة سعودية تقدم عملاً من تأليفها أول مخرجة سعودية تقدم عملاً من تأليفها أول مخرجة سعودية تقدم عملاً من تأليفها أول مخرجة سعودية تقدم عملاً من تأليفها أول مخرجة سعودية تقدم عملاً من تأليفها أول مخرجة سعودية تقدم عملاً من تأليفها د",
